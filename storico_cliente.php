...
<div class="griglia-4">
  <div class="card">
    <h3>telefono</h3>
    <div style="font-size:1.1rem;font-weight:600"><?php echo htmlspecialchars($cliente['telefono'] ?: '—') ?></div>
  </div>
  <div class="card">
    <h3>email</h3>
    <div style="font-size:1rem;font-weight:600;word-break:break-all"><?php echo htmlspecialchars($cliente['email'] ?: '—') ?></div>
  </div>
  <div class="card">
    <h3>visite completate</h3>
    <div class="valore"><?php echo $tot_visite ?></div>
  </div>
  <div class="card">
    <h3>totale speso</h3>
    <div class="valore" style="color:var(--success)">€<?php echo number_format($totale_speso, 2, ',', '.') ?></div>
  </div>
</div>
