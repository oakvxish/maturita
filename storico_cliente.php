...
<div class="griglia-4">
    ...
    <div class="card"><h3>totale speso</h3><div class="valore" style="color:var(--success)">â‚¬<?php echo number_format($totale_speso, 2, ',', '.') ?></div></div>
</div>
...
<div class="griglia-2">
    ...
    <div class="card">
        ...
        <div style="display:grid;gap:12px;font-size:.95rem">
            ...
            <div><strong>spesa media:</strong> <?php echo $tot_visite > 0 ? 'â‚¬' . number_format($totale_speso / $tot_visite, 2, ',', '.') : '-' ?></div>
            ...
            <tbody>
                <?php foreach ($storico as $a): ?>
                    <tr>
                        ...
                        <td>â‚¬<?php echo number_format((float) $a['prezzo'], 2, ',', '.') ?></td>
