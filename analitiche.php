...
<div class="page-toolbar">
  ...
  <form method="get" class="toolbar-row toolbar-row-compact">
...
<div class="griglia-4">
  <div class="card">
    ...
    <div class="valore" style="color:var(--success)">â‚¬<?php echo number_format($incasso_mese,2,',','.') ?></div>
  </div>
  <div class="card">
...
<div class="griglia-2">
  <div class="card">
    ...
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
      ...
      <div style="width:70px;text-align:right;font-size:.82rem;font-weight:600">â‚¬<?php echo number_format($im['totale'],0,',','.') ?></div>
    </div>
    <?php endforeach ?>
    <?php endif ?>
  </div>
  ...
  <div class="card">
    <h3 style="font-size:1rem;color:var(--text);margin-bottom:16px">appuntamenti per giorno â€” <?php echo $nomi_mesi[$mese] ?> <?php echo $anno ?></h3>
    <?php if (!$per_giorno): ?>
...
<?php if ($top_servizi): ?>
<div class="card">
  <h3 style="font-size:1rem;color:var(--text);margin-bottom:16px">top servizi â€” <?php echo $nomi_mesi[$mese] ?> <?php echo $anno ?></h3>
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $s['n'] ?></td>
        <td style="color:var(--success)">â‚¬<?php echo number_format($s['totale'],2,',','.') ?></td>
      </tr>
      <?php endforeach ?>
    </tbody>
  </table>
  ...
  <div class="stats-inline">
    ...
    <div class="stats-inline-item">
      ...
      <div class="valore" style="font-size:1.6rem">
        â‚¬<?php echo $tot_completati>0 ? number_format($incasso_mese/$tot_completati,2,',','.') : '0,00' ?>
      </div>
    </div>
  </div>
</div>
