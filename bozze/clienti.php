...
<div class="page-head">
    ...
    <div class="page-intro">Anagrafica chiara, ricerca rapida e schede facili da mantenere. I campi obbligatori sono pochi, così l’inserimento resta veloce anche quando il salone è pieno.</div>
</div>
...
<div class="metric-grid">
    ...
    <div class="metric"><div class="metric-label">vip</div><div class="metric-value"><?php echo $statsTag['vip'] ?? 0 ?></div><div class="metric-note">clienti ad alta priorità</div></div>
...
<div class="griglia-2">
    <div class="card">
        <div class="card-title-row">
            ...
            <div class="helper-text">prima i dati essenziali, poi le note</div>
        </div>
        <form method="post">
    ...
    <div class="card">
        ...
        <div class="surface-soft mt-16">
            ...
            <p class="mt-8">La tabella mostra sempre solo quello che corrisponde ai filtri attivi, così eviti confusione quando il database cresce.</p>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-title-row">
        ...
        <div class="helper-text">azioni rapide a destra per lavorare senza aprire schermate inutili</div>
    </div>
