...
/*
normalizza il ruolo letto dal database.
...
il proprietario compare prima, poi gli altri saloni in ordine alfabetico.
*/
...
/*
restituisce il salone corrente partendo dall'id salvato in sessione.
se non trova corrispondenza, il chiamante usera il primo salone disponibile.
*/
...
/*
controlla se la pagina puo essere vista nel salone corrente.
le pagine proprietario restano bloccate ai dipendenti.
*/
...
/*
blocca l'accesso alle sezioni riservate al proprietario.
quando il ruolo non basta, rimanda alla dashboard con un flash di errore.
*/
...
/*
legge un messaggio flash dalla sessione e lo consuma subito.
serve per evitare che lo stesso avviso resti visibile piu di una volta.
*/
...
/*
restituisce il nome piu leggibile dell'utente corrente.
usa nome se presente, altrimenti email o username.
*/
