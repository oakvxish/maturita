...
### Controllo permessi
Il controllo ruoli è centralizzato in `includes/auth.php`.
...
### Nota
Il flusso pubblico usa l'id del salone.
...
- aggiunta migration SQL: database/migrations/2026_03_26_password_reset.sql
