...
<body>
  ...
  <div class="page-wrap">
      ...
      <div class="conferma-body">
        ...
        <div>
          ...
          <p class="conferma-sub" style="margin-top:12px">
            Il nostro team ti contatterà nelle prossime ore per confermare l'appuntamento via WhatsApp o telefono.
            Conserva questo riepilogo come riferimento.
          </p>
        </div>
    ...
    <div class="nota-strip">
      <p>
        📲 <strong>Riceverai una conferma via WhatsApp</strong> al numero <?= $telefono ?: 'fornito' ?> entro poche ore
        durante l'orario di apertura (mar – sab, 9:00–19:00). Per urgenze puoi chiamarci al <strong>02 1234
          5678</strong>.
      </p>
    </div>
