...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-back::before { content: '←'; font-size: 0.95rem; }
    ...
    .hero-strip-title em { font-style: italic; color: var(--gold-light); }
    ...
    .conferma-img-col:hover img { transform: scale(1.04); }
    .conferma-img-badge {
    ...
    .check-icon svg { width: 24px; height: 24px; stroke: #fff; fill: none; stroke-width: 2.5; stroke-linecap: round; stroke-linejoin: round; }
    ...
    .conferma-heading em { font-style: italic; color: var(--gold); }
    ...
    .dettaglio-info { display: flex; flex-direction: column; gap: 2px; }
    .dettaglio-label {
      font-size: 0.65rem; letter-spacing: 0.15em; text-transform: uppercase;
      color: var(--muted);
    }
    .dettaglio-valore {
      font-size: 0.95rem; font-weight: 400; color: var(--charcoal);
    }
    ...
    .gallery-strip figure img {
      ...
      transition: transform 5s ease; filter: brightness(0.85);
    }
    .gallery-strip figure:hover img { transform: scale(1.06); filter: brightness(1); }
    ...
    .nota-strip strong { color: var(--charcoal); font-weight: 400; }
    ...
    @media (max-width: 700px) {
      .conferma-wrap { grid-template-columns: 1fr; }
      .conferma-img-col { min-height: 220px; }
