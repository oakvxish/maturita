...
<div class="metric-grid">
  ...
  <div class="metric"><div class="metric-label">prezzo medio</div><div class="metric-value">â‚¬<?php echo number_format($prezzoMedio,0,',','.') ?></div><div class="metric-note">indicatore sintetico del listino</div></div>
  ...
  <div class="card">
    <div class="card-title-row">
      <div>
        ...
        <div class="card-title-strong">perchÃ© tenere il listino pulito</div>
      </div>
    </div>
    <div class="surface-soft">
      <p>Durata e prezzo sono i due dati piÃ¹ utili per lavorare bene: aiutano a riempire lâ€™agenda, leggere lâ€™incasso e mantenere omogenea la prenotazione pubblica.</p>
    </div>
  </div>
</div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>â‚¬<?php echo number_format($s['prezzo'],2,',','.') ?></td>
            <td>
              <div class="toolbar-actions">
