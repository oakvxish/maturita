...
<div class="metric-grid">
  ...
  <div class="metric">
    ...
    <div class="metric-value" style="color:var(--ok)">â‚¬<?php echo number_format($incasso_mese,2,',','.') ?></div>
...
<div class="quick-grid">
  ...
  <a class="quick-link" href="home.php?id=<?php echo (int)$sid; ?>" target="_blank"><strong>Pagina pubblica</strong><span>anteprima cliente</span></a>
</div>
  ...
  <div class="card">
    <div class="card-title-row">
      <div>
        ...
        <div class="card-title-strong">servizi piÃ¹ richiesti</div>
      </div>
    </div>
...
<div class="card">
  <div class="card-title-row">
    <div>
      ...
      <div class="card-title-strong">orari piÃ¹ pieni</div>
    </div>
  </div>
