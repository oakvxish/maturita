...
<div class="griglia-4">
  <div class="card"><h3>clienti totali</h3><div class="valore"><?php echo $tot_clienti ?></div></div>
  <div class="card"><h3>appuntamenti oggi</h3><div class="valore"><?php echo $app_oggi ?></div></div>
  <div class="card"><h3>in attesa conferma</h3><div class="valore" style="color:var(--warning)"><?php echo $app_attesa ?></div></div>
  <div class="card"><h3>incasso mese</h3><div class="valore" style="color:var(--success)">€<?php echo number_format($incasso_mese,2,',','.') ?></div></div>
</div>
...
<div class="griglia-2">
  <div class="card">
    ...
    <?php else: ?>
    <table>
      <thead><tr><th>data/ora</th><th>cliente</th><th>servizio</th><th>stato</th></tr></thead>
      <tbody>
